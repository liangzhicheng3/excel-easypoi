...
public class Member {
    ...
    @Excel(name = "出生时间", width = 20, format = "yyyy-MM-dd")
    private Date birthday;
    @Excel(name = "手机号码", width = 20, needMerge = true, desensitizationRule = "3_4")
